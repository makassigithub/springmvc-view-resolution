...
public class HomeController
{
    ...
    // the Default response entity is Xml ( must add @XmlRootElement on User.java)
    //for /user/id.json spring will call the json converter to convert the xml to json and return it
